...
$('.increment-btn agregar').click(function (event) {
    "use strict";
    event.preventDefault(); 
    let cada_producto_id =$(this).parent().get(0).id; /*$(this).parent().find("product_data").val();+/       /*$(this).parent().get(0).id;*/
